...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SeitCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seitcointools.com", "dnsseed.seitcointools.com"},
    {"seitcoinpool.org", "dnsseed.seitcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"seitcointools.com", "testnet-seed.seitcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SeitCoin is probably already running."), addrBind.ToString().c_str());
        else
